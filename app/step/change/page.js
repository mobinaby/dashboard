              ...
              <div className="w-full h-[70px] py-4 flex gap-8 items-center mt-3 ">
                <div className="w-[263px] h-[38px] flex gap-4 items-center">
                  ...
                  <span className="font-normal text-base">
                    مرحله ارسال به ایران
                  </span>
                </div>
                <div className="w-[570px] h-[38px] flex gap-8 items-center">
                  <button className="w-[160px] h-[38px] rounded-full bg-[#283C63] font-bold text-white text-sm">
                    بازگشت به مرحله قبل
                  </button>
                  <div className="w-[81px] h-8 flex gap-2.5 items-center">
                    <input
                      type="checkbox"
                      className="w-7 h-7 rounded border-[1px] border-[#D1D1D6]"
                    />
